...
object Compositions {
  ...
  def test1(num: Int): Int = num + 1

  def test2(num: Int): Int = num + 2

  def test3(num: Int): Int = num + 3

  def test1op(num: Int): Option[Int] = Some(num + 1)

  def test2op(num: Int): Option[Int] = Some(num + 2)

  def test3op(num: Int): Option [Int] = Some(num + 3)

  def main(args: Array[String]): Unit = {
    println(testCompose(test1)(test2)(test3)(5) )
    println(testMapFlatMap(test1op)(test2op)(test3op)(Some(5)))
    println(testForComprehension(test1op)(test2op)(test3op)(Some(5)))
  }
}
